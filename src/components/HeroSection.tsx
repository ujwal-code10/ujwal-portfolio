...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="min-h-screen bg-gradient-to-br from-navy-900 via-navy-800 to-navy-700 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 flex items-center min-h-screen">
        <div className="grid lg:grid-cols-2 gap-12 items-center w-full">
          <div className="text-white animate-fade-in-up">
            ...
            <h2 className="text-2xl lg:text-3xl font-light mb-6 text-navy-100">
              Freelance Web Designer & Developer
            </h2>
            <p className="text-xl text-navy-200 mb-8 leading-relaxed max-w-lg">
          ...
          <div className="lg:flex justify-center animate-scale-in" style={{ animationDelay: '0.3s' }}>
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 bg-gradient-to-br from-electric-400 to-coral-400 rounded-3xl shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500"></div>
              <div className="absolute inset-4 bg-navy-800 rounded-3xl flex items-center justify-center">
                <div className="text-center text-white">
                  <div className="text-6xl mb-4">💻</div>
                  <p className="text-lg font-medium">AI-Enhanced</p>
