...
const Footer = () => {
  ...
  return (
    <footer className="bg-navy-800 text-navy-200 py-12 border-t border-navy-700">
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-4 text-sm">
              <span className="bg-navy-700 px-3 py-1 rounded-full">React</span>
              <span className="bg-navy-700 px-3 py-1 rounded-full">TypeScript</span>
              <span className="bg-navy-700 px-3 py-1 rounded-full">Tailwind</span>
            </div>
          </div>
